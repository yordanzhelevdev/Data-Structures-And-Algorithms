...
// 	do{
// 		//First we check if the numb has a remainder
// 		s.push(num % base);
// 		//then we divide the num
// 		num = Math.floor(num /= base);
// 	}
// 	//and check if the num is bigger than zero
// 	while (num > 0);
...
//Checking if string is Palidrome with stacks
...
console.log(removePezElement('yellow'))
